...
@{
    ...
    TextEditor = 'brackets'           # Default text editor used by the Edit-File function
    ...
    ModulesToImport = @{
        ...
        Net               = $true
        Prompt            = $true    # Disabled by default because a lot of users already have established prompt functions.
